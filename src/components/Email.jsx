...
const Email = () => {
    ...
    <div className="grid grid-rows-form w-[300px] justify-center">
      <img src={logo} alt="logo" className="w-[150px] mb-[48px] justify-self-center hidden"/>

      <h1 className="text-lg mb-[12px] text-center">Email has been sent!</h1>
      <p className="text-verylightpink text-base font-[300] mt-0 mb-[32px] text-center">Please check your inbox for instructions on how to reset the password</p>
      ...
      <button className="bg-hospitalgreen mt-[14px] mb-[30px] text-white w-full cursor-pointer text-base font-bold h-[50px] border-none rounded-md">Login</button>
